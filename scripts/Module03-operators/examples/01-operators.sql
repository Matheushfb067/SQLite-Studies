-- database: ../../../database/module03-operators/examples/01-operators.sqlite
...
SELECT * FROM "produtos" WHERE ("preco" + "taxa_importacao") > 4000;
SELECT * FROM "produtos" WHERE "id" = 3;


SELECT * FROM "produtos" WHERE "criado" > '2049';
SELECT * FROM "produtos" WHERE "criado" > '2049-08';
SELECT * FROM "produtos" WHERE "criado" > '2049-08-03';
--erro, irá ignorar o -3 uma vez que não está no formato DD
SELECT * FROM "produtos" WHERE "criado" > '2049-08-3';
